...
import { GetClientListRequest } from 'src/modules/Clients/model/getClientListRequest';
import {GetClientListResponse} from 'src/modules/Clients/model/getClientLisResponse';
...
export const getClientList = async (
  payload: GetClientListRequest,
): Promise<GetClientListResponse> => {
  console.log(`${CLIENTS_ENDPOINTS.GET_CLIENTS}?${buildListingRequestPayload(payload)}`);
  const url = `${CLIENTS_ENDPOINTS.GET_CLIENTS}?${buildListingRequestPayload(payload)}`;
  return await request.get(url);
};
...
//   return await request.post(CLIENTS_ENDPOINTS.CREATE_CLIENT, payload);
// };

// export const getClientDetail = async (clientId: string): Promise<GetClientResponse> => {
//   return await request.get(CLIENTS_ENDPOINTS.GET_CLIENT_BY_ID(clientId));
// };
...
// ): Promise<GetClientResponse> => {
//   return await request.patch(CLIENTS_ENDPOINTS.UPDATE_CLIENT(id), payload);
// };
